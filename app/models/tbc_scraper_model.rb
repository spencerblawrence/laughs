# make this a class
# create a method called get_tbc_data
# can either call the  method in rails console, or call it via a rake task
# figure out how to keep URLs updated
...
url_array.each do |url|
  ...
  Event.create!(title: "#{title}", description: "#{description}", start_date_time: "#{start_date_time}", end_date_time: "#{end_date_time}", location: "#{location}", cost: "#{cost}", website: "#{website}")
end
