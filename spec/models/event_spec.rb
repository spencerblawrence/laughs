...
describe Event do
  ...
  it { should have_valid(:venue).when("The Green Briar") }
  ...
  it { should have_valid(:address).when("Somerville Brewing Company Brewery + Taproom, 15 Ward St, Somerville, MA, 02143") }
